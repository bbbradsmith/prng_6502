...
cc65\bin\ca65 -o output\galois8.o -g other\galois8.s
@IF ERRORLEVEL 1 GOTO error
...
cc65\bin\ld65 -o output\test.bin -C test.cfg -m output\test.bin.map output\test.c.o output\common.o output\galois16.o output\galois24.o output\galois32.o output\galois8.o output\xorshift.o sim6502.lib
@IF ERRORLEVEL 1 GOTO error
