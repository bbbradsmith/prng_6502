...
cc65\bin\ld65 -o output\test.bin -C test.cfg -m output\test.bin.map output\test.c.o output\common.o output\galois16.o output\galois24.o output\galois32.o sim6502.lib
@IF ERRORLEVEL 1 GOTO error
